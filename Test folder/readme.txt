...
This program assumes that the Roku application is in C:\Test folder, if you want to install in any other place you will have to change this directory path in every single file.